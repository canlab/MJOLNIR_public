...
# Create a quntitative variable of covid skeptism
...
CovidSkepticism =~ Attention + Conspiracy + Origin + Politics + Coverage + AntiVacc
'
```
...
df_scorecovmis <- f_semscoring_latent(fit, df_covmis, scaled = TRUE)
df_scorecovmis
```
