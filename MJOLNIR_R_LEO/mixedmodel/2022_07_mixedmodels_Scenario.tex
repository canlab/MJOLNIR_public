...
\begin{table}
	...
	\begin{tabular}[t]{lcccccccc}
		\toprule
		& CC A path & CC B path & CC C path & CC C' path & TC A path & TC B path & TC C path & TC C' path\\
		\midrule
		(Intercept) & \num{23.50}[\num{18.69},\num{28.30}]*** & \num{28.64}[\num{27.04},\num{30.24}]*** & \num{12.19}[\num{3.98},\num{20.40}]** & \num{21.24}[\num{16.58},\num{25.89}]*** & \num{27.32}[\num{22.49},\num{32.15}]*** & \num{28.02}[\num{26.37},\num{29.67}]*** & \num{12.19}[\num{3.98},\num{20.40}]** & \num{24.85}[\num{20.20},\num{29.50}]***\\
		& t=\num{9.58}, se=\num{2.45} & t=\num{35.10}, se=\num{0.82} & t=\num{2.91}, se=\num{4.19} & t=\num{8.95}, se=\num{2.37} & t=\num{11.08}, se=\num{2.46} & t=\num{33.29}, se=\num{0.84} & t=\num{2.91}, se=\num{4.19} & t=\num{10.48}, se=\num{2.37}\\
		& p=\num{0.00}, df=\num{2373.00} & p=\num{0.00}, df=\num{2392.00} & p=\num{0.00}, df=\num{2373.00} & p=\num{0.00}, df=\num{2372.00} & p=\num{0.00}, df=\num{2373.00} & p=\num{0.00}, df=\num{2392.00} & p=\num{0.00}, df=\num{2373.00} & p=\num{0.00}, df=\num{2372.00}\\ \hline
...
\begin{table}
	...
	\begin{tabular}[t]{lccccccccccc}
		\toprule
		& MW A path & MW B1 path & MW B2 path & MW B3 path & MW B4 path & MW C1 path & MW C2 path & MW C'1 path & MW C'2 path & MW C'3 path & MW C'4 path\\
		\midrule
		(Intercept) & \num{-6.62}[\num{-10.60},\num{-2.65}]** & \num{-2.66}[\num{-3.29},\num{-2.04}]*** & \num{-2.64}[\num{-3.27},\num{-2.01}]*** & \num{-2.60}[\num{-3.23},\num{-1.96}]*** & \num{-2.60}[\num{-3.23},\num{-1.97}]*** & \num{0.08}[\num{-2.60},\num{2.76}] & \num{4.01}[\num{1.23},\num{6.79}]** & \num{-6.62}[\num{-10.60},\num{-2.65}]** & \num{-6.48}[\num{-10.46},\num{-2.50}]** & \num{-6.51}[\num{-10.49},\num{-2.53}]** & \num{-6.49}[\num{-10.47},\num{-2.51}]**\\
		& t=\num{-3.27}, se=\num{2.03} & t=\num{-8.31}, se=\num{0.32} & t=\num{-8.22}, se=\num{0.32} & t=\num{-8.02}, se=\num{0.32} & t=\num{-8.04}, se=\num{0.32} & t=\num{0.06}, se=\num{1.37} & t=\num{2.83}, se=\num{1.42} & t=\num{-3.26}, se=\num{2.03} & t=\num{-3.19}, se=\num{2.03} & t=\num{-3.21}, se=\num{2.03} & t=\num{-3.20}, se=\num{2.03}\\
		& p=\num{0.00}, df=\num{4769.00} & p=\num{0.00}, df=\num{4788.00} & p=\num{0.00}, df=\num{4788.00} & p=\num{0.00}, df=\num{4787.00} & p=\num{0.00}, df=\num{4786.00} & p=\num{0.95}, df=\num{4769.00} & p=\num{0.00}, df=\num{4769.00} & p=\num{0.00}, df=\num{4768.00} & p=\num{0.00}, df=\num{4768.00} & p=\num{0.00}, df=\num{4767.00} & p=\num{0.00}, df=\num{4766.00}\\
...
\begin{table}
	...
	\begin{tabular}[t]{lccccc}
		\toprule
		& Other\textasciitilde{}Self & AllProd & AllProdCross & Prod2level & Prod2levelCross\\
		\midrule
		(Intercept) & \num{3.32}[\num{2.58},\num{4.06}]*** & \num{1.20}[\num{-0.53},\num{2.94}] & \num{3.78}[\num{1.70},\num{5.86}]*** & \num{2.41}[\num{1.14},\num{3.67}]*** & \num{3.47}[\num{1.95},\num{5.00}]***\\
		& t=\num{8.76}, se=\num{0.38} & t=\num{1.36}, se=\num{0.89} & t=\num{3.56}, se=\num{1.06} & t=\num{3.72}, se=\num{0.65} & t=\num{4.47}, se=\num{0.78}\\
		& p=\num{0.00}, df=\num{4788.00} & p=\num{0.17}, df=\num{4773.00} & p=\num{0.00}, df=\num{4758.00} & p=\num{0.00}, df=\num{4781.00} & p=\num{0.00}, df=\num{4774.00}\\
		...
		&  &  &  &  & t=\num{-2.10}, se=\num{0.04}\\
		&  &  &  &  & p=\num{0.04}, df=\num{4774.00}\\
		MorallyWrong\_selfV\_ProductMorMorallyQuestionableV\_RacenamefIndian &  &  &  &  & \num{-0.03}[\num{-0.11},\num{0.05}]\\
		&  &  &  &  & t=\num{-0.81}, se=\num{0.04}\\
		&  &  &  &  & p=\num{0.42}, df=\num{4774.00}\\
		SD (Intercept ID) & \num{6.17} & \num{6.27} & \num{6.28} & \num{6.23} & \num{6.28}\\
		& t=, se= & t=, se= & t=, se= & t=, se= & t=, \vphantom{1} se=\\
		& p=, df= & p=, df= & p=, df= & p=, df= & p=, \vphantom{1} df=\\
		SD (Observations) & \num{13.37} & \num{13.29} & \num{13.13} & \num{13.33} & \num{13.31}\\
		& t=, se= & t=, se= & t=, se= & t=, se= & t=, se=\\
		& p=, df= & p=, df= & p=, df= & p=, df= & p=, df=\\
		\midrule
		Num.Obs. & \num{4792} & \num{4792} & \num{4792} & \num{4792} & \num{4792}\\
		R2 Marg. & \num{0.733} & \num{0.733} & \num{0.737} & \num{0.732} & \num{0.732}\\
		R2 Cond. & \num{0.780} & \num{0.781} & \num{0.786} & \num{0.780} & \num{0.781}\\
